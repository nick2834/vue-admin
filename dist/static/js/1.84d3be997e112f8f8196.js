...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_wangeditor__ = __webpack_require__(1020);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_wangeditor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_wangeditor__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data() {
        return {
            editorContent: '',
            uploader: '',
            editorBox: new __WEBPACK_IMPORTED_MODULE_1_wangeditor___default.a('#editorElem')
        };
    },
    methods: {
        getContent: function () {
        ...
        editorInit() {
            ...
            this.editorBox.customConfig.uploadImgServer = '/upload'; // 上传图片到服务器
            this.editorBox.customConfig.qiniu = true;
            this.editorBox.create();
        },
        getToken() {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_api__["c" /* getQiniuToken */])().then(res => {
                this.tokenToken = res.data.token;
                this.$nextTick(() => {
                    let that = this;
                    this.qiniuInit(this.tokenToken);
                });
            });
        },
        qiniuInit(token) {
            var btnId = this.editorBox.imgMenuId;
            var containerId = this.editorBox.toolbarElemId;
            var textElemId = this.editorBox.textElemId;
            let that = this;
            this.uploader = Qiniu.uploader({
                ...
                domain: baseImgUrl, //bucket 域名，下载资源时用到，**必需**
                ...
                init: {
                    ...
                    'FileUploaded': function (up, file, info) {
                        ...
                        var sourceLink = domain + JSON.parse(info.response).key; //获取上传成功后的文件的Url
                        // 插入图片到editor
                        that.editorBox.cmd.do('insertHtml', '<img src="' + sourceLink + '" style="max-width:100%;"/>');
                    },
...
(function (global, factory) {
     true ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.wangEditor = factory();
})(this, function () {
    'use strict';
...
var update = __webpack_require__(992)("15c1c656", content, true);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_editor__ = __webpack_require__(993);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_components_editor___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_components_editor__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_AMap__ = __webpack_require__(1141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_AMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_AMap__);
//
//
//
//
...
const defaultForm = {
    ...
    video_image: '',
    video_length: '',
    author_id: JSON.parse(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_untils_auth__["a" /* getToken */])('id')),
    topic_type: 'video',
    address: '',
    lat: null,
    lng: null,
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data() {
        return {
            ins: new frontQnUper(__WEBPACK_IMPORTED_MODULE_2_api__["G" /* options */]),
    ...
    components: { Editor: __WEBPACK_IMPORTED_MODULE_0_components_editor___default.a },
    methods: {
        mapInit() {
            let that = this;
            map = new __WEBPACK_IMPORTED_MODULE_3_AMap___default.a.Map('container', {
                resizeEnable: true,
                zoom: 12
            });
            __WEBPACK_IMPORTED_MODULE_3_AMap___default.a.plugin('AMap.Geocoder', function () {
                var geocoder = new __WEBPACK_IMPORTED_MODULE_3_AMap___default.a.Geocoder({
                    city: "上海" //城市，默认：“全国”
                });
                var marker = new __WEBPACK_IMPORTED_MODULE_3_AMap___default.a.Marker({
                    map: map,
                    bubble: true
                });
        ...
        submitForm() {
            this.$refs.postForm.validate(valid => {
                if (valid) {
                    ...
                    //转换图片数组为字符串赋值
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_api__["J" /* createTopic */])(this.formData).then(res => {
                        if (res.code === 1) {
                            this.$notify({
                                title: '成功',
                                message: '发布文章成功',
        ...
        setDraft() {
            this.loading = true;
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_untils_auth__["b" /* setToken */])('draft', this.formData);
            this.$notify({
                title: '成功',
                message: '存草稿成功',
                type: 'success',
        ...
        getDraft() {
            if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_untils_auth__["a" /* getToken */])('draft')) {
                this.formData = JSON.parse(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_untils_auth__["a" /* getToken */])('draft'));
...
// module
exports.push([module.i, ".postForm[data-v-c7286756]{position:relative;display:flex}.postForm #posterUrl[data-v-c7286756]{float:left}.upload-container[data-v-c7286756]{width:100%;position:relative;overflow:hidden}.upload-container .image-preview[data-v-c7286756]{width:100px;height:100px;position:relative;float:left;margin-right:10px}.upload-container .image-preview .image-preview-wrapper[data-v-c7286756]{position:relative;width:100%;height:100%}.upload-container .image-preview .image-preview-wrapper img[data-v-c7286756]{width:100%;height:100%}.upload-container .image-preview .image-preview-action[data-v-c7286756]{position:absolute;width:100%;height:100%;left:0;top:0;color:#fff;opacity:0;font-size:20px;background-color:rgba(0,0,0,.5);transition:opacity .3s;cursor:pointer;text-align:center;line-height:100px}.upload-container .image-preview .image-preview-action .el-icon-delete[data-v-c7286756],.upload-container .image-preview .image-preview-action .el-icon-plus[data-v-c7286756]{font-size:18px}.upload-container .image-preview .image-preview-action input[data-v-c7286756]{width:100%;height:100%;position:absolute;top:0;left:0;opacity:0;cursor:pointer}.upload-container .image-preview:hover .image-preview-action[data-v-c7286756]{opacity:1}.upload-container .image-uploader[data-v-c7286756]{opacity:1!important}.editor-container[data-v-c7286756]{margin:0 0 30px}.editor-container .editor-upload-btn-container[data-v-c7286756]{text-align:right;margin-right:10px}.editor-container .editor-upload-btn-container .editor-upload-btn[data-v-c7286756]{display:inline-block}.edit_upload[data-v-c7286756]{position:relative}.filebox[data-v-c7286756]{position:absolute;left:80%;margin-left:10px}", "", {"version":3,"sources":["/Users/subang/bulunu-admin/src/views/content/createTopic.vue"],"names":[],"mappings":"AACA,2BACE,kBAAmB,AACnB,YAAc,CACf,AACD,sCACI,UAAY,CACf,AACD,mCACE,WAAY,AACZ,kBAAmB,AACnB,eAAiB,CAClB,AACD,kDACI,YAAa,AACb,aAAc,AACd,kBAAmB,AACnB,WAAY,AACZ,iBAAmB,CACtB,AACD,yEACM,kBAAmB,AACnB,WAAY,AACZ,WAAa,CAClB,AACD,6EACQ,WAAY,AACZ,WAAa,CACpB,AACD,wEACM,kBAAmB,AACnB,WAAY,AACZ,YAAa,AACb,OAAQ,AACR,MAAO,AACP,WAAY,AACZ,UAAW,AACX,eAAgB,AAChB,gCAAqC,AACrC,uBAAwB,AACxB,eAAgB,AAChB,kBAAmB,AACnB,iBAAmB,CACxB,AAID,8KACQ,cAAgB,CACvB,AACD,8EACQ,WAAY,AACZ,YAAa,AACb,kBAAmB,AACnB,MAAO,AACP,OAAQ,AACR,UAAW,AACX,cAAgB,CACvB,AACD,8EACM,SAAW,CAChB,AACD,mDACI,mBAAsB,CACzB,AACD,mCACE,eAAiB,CAClB,AACD,gEACI,iBAAkB,AAClB,iBAAmB,CACtB,AACD,mFACM,oBAAsB,CAC3B,AACD,8BACE,iBAAmB,CACpB,AACD,0BACE,kBAAmB,AACnB,SAAU,AACV,gBAAkB,CACnB","file":"createTopic.vue","sourcesContent":["\n.postForm[data-v-c7286756] {\n  position: relative;\n  display: flex;\n}\n.postForm #posterUrl[data-v-c7286756] {\n    float: left;\n}\n.upload-container[data-v-c7286756] {\n  width: 100%;\n  position: relative;\n  overflow: hidden;\n}\n.upload-container .image-preview[data-v-c7286756] {\n    width: 100px;\n    height: 100px;\n    position: relative;\n    float: left;\n    margin-right: 10px;\n}\n.upload-container .image-preview .image-preview-wrapper[data-v-c7286756] {\n      position: relative;\n      width: 100%;\n      height: 100%;\n}\n.upload-container .image-preview .image-preview-wrapper img[data-v-c7286756] {\n        width: 100%;\n        height: 100%;\n}\n.upload-container .image-preview .image-preview-action[data-v-c7286756] {\n      position: absolute;\n      width: 100%;\n      height: 100%;\n      left: 0;\n      top: 0;\n      color: #fff;\n      opacity: 0;\n      font-size: 20px;\n      background-color: rgba(0, 0, 0, 0.5);\n      transition: opacity .3s;\n      cursor: pointer;\n      text-align: center;\n      line-height: 100px;\n}\n.upload-container .image-preview .image-preview-action .el-icon-delete[data-v-c7286756] {\n        font-size: 18px;\n}\n.upload-container .image-preview .image-preview-action .el-icon-plus[data-v-c7286756] {\n        font-size: 18px;\n}\n.upload-container .image-preview .image-preview-action input[data-v-c7286756] {\n        width: 100%;\n        height: 100%;\n        position: absolute;\n        top: 0;\n        left: 0;\n        opacity: 0;\n        cursor: pointer;\n}\n.upload-container .image-preview:hover .image-preview-action[data-v-c7286756] {\n      opacity: 1;\n}\n.upload-container .image-uploader[data-v-c7286756] {\n    opacity: 1 !important;\n}\n.editor-container[data-v-c7286756] {\n  margin: 0 0 30px;\n}\n.editor-container .editor-upload-btn-container[data-v-c7286756] {\n    text-align: right;\n    margin-right: 10px;\n}\n.editor-container .editor-upload-btn-container .editor-upload-btn[data-v-c7286756] {\n      display: inline-block;\n}\n.edit_upload[data-v-c7286756] {\n  position: relative;\n}\n.filebox[data-v-c7286756] {\n  position: absolute;\n  left: 80%;\n  margin-left: 10px;\n}\n"],"sourceRoot":""}]);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(992)("b9286046", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('el-col', {
  ...
  }, [_vm._v("话题管理")]), _vm._v(" "), _c('el-breadcrumb-item', [_vm._v("创建话题")])], 1)], 1), _vm._v(" "), _c('el-form', {
    ref: "postForm",
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.$set(_vm.formData, "author_id", $$v)
      },
    ...
    model: {
      value: (_vm.formData.topic_type),
      callback: function($$v) {
        _vm.$set(_vm.formData, "topic_type", $$v)
      },
      expression: "formData.topic_type"
    }
  }, [_c('el-option', {
    attrs: {
      "label": "图文类型",
    ...
    model: {
      value: (_vm.formData.lng),
      callback: function($$v) {
        _vm.$set(_vm.formData, "lng", $$v)
      },
      expression: "formData.lng"
    }
  })], 1)], 1), _vm._v(" "), _c('el-col', {
    attrs: {
      "span": 6
    ...
    model: {
      value: (_vm.formData.license),
      callback: function($$v) {
        _vm.$set(_vm.formData, "license", $$v)
      },
      expression: "formData.license"
    }
  })], 1)], 1), _vm._v(" "), _c('el-col', [(_vm.formData.topic_type === 'video') ? _c('div', [_c('el-form-item', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.formData.video_image),
      expression: "formData.video_image"
    }],
    ref: "posterUrl",
    staticClass: "el-input__inner",
    staticStyle: {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.$set(_vm.formData, "video_image", $event.target.value)
      }
    }
  }), _vm._v(" "), _c('el-button', {
    staticClass: "filebox"
  ...
  })], 1)], 1) : (_vm.formData.topic_type === 'image') ? _c('div', [_c('el-form-item', {
    staticClass: "edit_upload",
    attrs: {
      "label-width": "100px",
      "label": "图片画廊",
  ...
  })], 1)], 1)]), _vm._v(" "), _c('el-col', [_c('el-form-item', [_c('el-button', {
    attrs: {
      "type": "primary",
      "loading": _vm.loading
    },
  ...
  }, [_vm._v("存为草稿")])], 1)], 1)], 1), _vm._v(" "), _c('el-dialog', {
    attrs: {
      "title": "高德地图",
...
//# sourceMappingURL=1.84d3be997e112f8f8196.js.map